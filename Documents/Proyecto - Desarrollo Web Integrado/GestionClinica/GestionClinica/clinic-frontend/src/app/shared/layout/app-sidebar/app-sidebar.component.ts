...
export class AppSidebarComponent {
  ...
  // Ítems principales de navegación de la Clínica Médica
  navItems: NavItem[] = [
    {
    ...
    {
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M16 7C16 9.20914 14.2091 11 12 11C9.79086 11 8 9.20914 8 7C8 4.79086 9.79086 3 12 3C14.2091 3 16 4.79086 16 7Z" fill="currentColor"/><path fill-rule="evenodd" clip-rule="evenodd" d="M12 14C8.13401 14 5 17.134 5 21H19C19 17.134 15.866 14 12 14Z" fill="currentColor"/></svg>`,
      name: "Gestión de Pacientes",
      path: "/pacientes"
    },
    {
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M19 3H5C3.89543 3 3 3.89543 3 4V20C3 21.1046 3.89543 22 5 22H19C20.1046 22 21 21.1046 21 20V4C21 3.89543 20.1046 3 19 3Z" stroke="currentColor" stroke-width="2" stroke-linejoin="round"/><path d="M7 7H17" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><path d="M7 12H17" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><path d="M7 17H13" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg>`,
  ...
  // Desactivamos la sección "Others" por completo dejándola vacía
  othersItems: NavItem[] = [];
